    ...
    <aside className="panel panel-controls">
      ...
      <section className="panel-section">
        ...
        <input
          ...
          aria-describedby={keyInputError ? "btree-key-input-error" : undefined}
          onChange={(event) => onKeyInputChange(event.target.value)}
          placeholder="例: 35"
        />
        {keyInputError ? (
          <p id="btree-key-input-error" className="field-error">
            {keyInputError}
          </p>
        ) : null}
        <div className="button-row">
      ...
      <section className="panel-section">
        ...
        <div className="range-input-grid">
          <label className="field-label" htmlFor="btree-range-start-input">
            ...
            <input
              ...
              aria-describedby={
                rangeInputError ? "btree-range-input-error" : undefined
              }
        ...
        {rangeInputError ? (
          <p id="btree-range-input-error" className="field-error">
            {rangeInputError}
          </p>
        ) : null}
        <button
